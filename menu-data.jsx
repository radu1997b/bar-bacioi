...
const MENU_DATA = [
  {
    ...
    items: [
      { id: 'b1', name: { ro: 'Ouă Benedict', ru: 'Яйца Бенедикт' }, desc: { ro: 'ou poșat, șuncă, sos olandez, brioșă', ru: 'яйцо пашот, ветчина, голландез, булочка' }, price: 145, tag: { ro: 'Recomandare', ru: 'Хит' } },
    ...
    subs: [
      {
        ...
        items: [
          { id: 'gr1', name: { ro: 'Tartar de vită', ru: 'Тартар из говядины' }, desc: { ro: 'mușchi de vită, gălbenuș, capere, pâine prăjită', ru: 'говяжья вырезка, желток, каперсы, тосты' }, price: 220, tag: { ro: 'Recomandare', ru: 'Хит' } },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'sa3', name: { ro: 'Salată cu file de rață', ru: 'Салат с уткой' }, desc: { ro: 'rață, mix de salate, portocală, dressing balsamic', ru: 'утка, микс салатов, апельсин, бальзамик' }, price: 175, tag: { ro: 'Recomandare', ru: 'Хит' } },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'su3', name: { ro: 'Supă cremă de ciuperci', ru: 'Крем-суп из грибов' }, desc: { ro: 'ciuperci porcini, smântână, ulei de trufe', ru: 'белые грибы, сливки, трюфельное масло' }, price: 125, tag: { ro: 'Recomandare', ru: 'Хит' } },
      ...
      },
      {
        ...
        items: [
          { id: 'pa1', name: { ro: 'Cacio e pepe', ru: 'Качо э пепе' }, desc: { ro: 'tonnarelli, pecorino, piper negru', ru: 'тоннарелли, пекорино, чёрный перец' }, price: 175, tag: { ro: 'Recomandare', ru: 'Хит' } },
      ...
      },
      {
        ...
        items: [
          { id: 'ca1', name: { ro: 'Burger Bacioi', ru: 'Бургер Bacioi' }, desc: { ro: 'vită 200g, cheddar, ceapă caramelizată, cartofi', ru: 'говядина 200г, чеддер, лук карамель, картофель' }, price: 195, tag: { ro: 'Recomandare', ru: 'Хит' } },
    ...
    subs: [
      {
        ...
        items: [
          { id: 'co1', name: { ro: 'Disco Sour', ru: 'Disco Sour' }, desc: { ro: 'bourbon, lămâie, albuș, bitter', ru: 'бурбон, лимон, белок, биттер' }, price: 130, tag: { ro: 'Recomandare', ru: 'Хит' } },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'li2', name: { ro: 'Limonadă pepene & busuioc', ru: 'Лимонад арбуз & базилик' }, desc: { ro: 'pepene roșu, busuioc, lime', ru: 'арбуз, базилик, лайм' }, price: 85, tag: { ro: 'Recomandare', ru: 'Хит' } },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'hd5', name: { ro: 'Ciocolată caldă', ru: 'Горячий шоколад' }, desc: { ro: 'ciocolată 70%, frișcă', ru: 'шоколад 70%, сливки' }, price: 75, tag: { ro: 'Recomandare', ru: 'Хит' } },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'w2', name: { ro: 'Rara Neagră', ru: 'Рара Нягрэ' }, desc: { ro: 'roșu sec, Moldova — pahar / sticlă', ru: 'красное сухое, Молдова — бокал / бутылка' }, price: 85, priceBottle: 420, tag: { ro: 'Recomandare', ru: 'Хит' } },
  ...
  },
  {
    ...
    items: [
      { id: 'h1', name: { ro: 'Mix Bacioi', ru: 'Микс Bacioi' }, desc: { ro: 'mango, maracuja, mentă', ru: 'манго, маракуйя, мята' }, price: 350, tag: { ro: 'Recomandare', ru: 'Хит' } },
