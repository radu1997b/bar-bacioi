...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ('b1', 'mic-dejun', NULL, 'Ouă Benedict', 'Яйца Бенедикт', 'ou poșat, șuncă, sos olandez, brioșă', 'яйцо пашот, ветчина, голландез, булочка', 145, NULL, 0, 'recommended', 1),
...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ('gr1', 'bucatarie', 'gustari-reci', 'Tartar de vită', 'Тартар из говядины', 'mușchi de vită, gălbenuș, capere, pâine prăjită', 'говяжья вырезка, желток, каперсы, тосты', 220, NULL, 0, 'recommended', 1),
...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ...
  ('sa3', 'bucatarie', 'salate', 'Salată cu file de rață', 'Салат с уткой', 'rață, mix de salate, portocală, dressing balsamic', 'утка, микс салатов, апельсин, бальзамик', 175, NULL, 0, 'recommended', 3),
...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ...
  ('su3', 'bucatarie', 'supe', 'Supă cremă de ciuperci', 'Крем-суп из грибов', 'ciuperci porcini, smântână, ulei de trufe', 'белые грибы, сливки, трюфельное масло', 125, NULL, 0, 'recommended', 3),
...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ('pa1', 'bucatarie', 'paste', 'Cacio e pepe', 'Качо э пепе', 'tonnarelli, pecorino, piper negru', 'тоннарелли, пекорино, чёрный перец', 175, NULL, 0, 'recommended', 1),
...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ('ca1', 'bucatarie', 'carne', 'Burger Bacioi', 'Бургер Bacioi', 'vită 200g, cheddar, ceapă caramelizată, cartofi', 'говядина 200г, чеддер, лук карамель, картофель', 195, NULL, 0, 'recommended', 1),
...
-- Items: bar / cocktail
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ('co1', 'bar', 'cocktail', 'Disco Sour', 'Disco Sour', 'bourbon, lămâie, albuș, bitter', 'бурбон, лимон, белок, биттер', 130, NULL, 0, 'recommended', 1),
...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ...
  ('li2', 'bar', 'limonade', 'Limonadă pepene & busuioc', 'Лимонад арбуз & базилик', 'pepene roșu, busuioc, lime', 'арбуз, базилик, лайм', 85, NULL, 0, 'recommended', 2),
...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ...
  ('hd5', 'bar', 'hot-drinks', 'Ciocolată caldă', 'Горячий шоколад', 'ciocolată 70%, frișcă', 'шоколад 70%, сливки', 75, NULL, 0, 'recommended', 5),
...
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ...
  ('w2', 'vin', NULL, 'Rara Neagră', 'Рара Нягрэ', 'roșu sec, Moldova — pahar / sticlă', 'красное сухое, Молдова — бокал / бутылка', 85, 420, 0, 'recommended', 2),
...
-- Items: hookah (flat)
INSERT OR IGNORE INTO items (id, category_id, subcategory_id, name_ro, name_ru, desc_ro, desc_ru, price, price_bottle, bottle_only, tag_id, sort_order) VALUES
  ('h1', 'hookah', NULL, 'Mix Bacioi', 'Микс Bacioi', 'mango, maracuja, mentă', 'манго, маракуйя, мята', 350, NULL, 0, 'recommended', 1),
